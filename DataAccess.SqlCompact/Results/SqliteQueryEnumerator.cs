...
namespace DataAccess.SqlCompact.Results
{
    ...
    /// </summary>
    public class SqlCompactQueryEnumerator : IEnumerable<IQueryRow>, IEnumerator<IQueryRow>
    {
        private SqlCompactQueryData _qd;
        ...
        public SqlCompactQueryEnumerator(SqlCompactQueryData qd)
        {
            _qd = qd;
        }
