...
using TheCodeHaven.SauceClassGeneration;

namespace SauceClassGeneration_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new SauceClassGenerationPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(SauceClassGenerationPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
