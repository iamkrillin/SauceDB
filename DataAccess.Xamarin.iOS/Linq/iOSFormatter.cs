...
namespace DataAccess.Xamarin.iOS.Linq
{
    ...
    /// 
    /// </summary>
    public class iOSFormatter : SqlFormatter
    {
        /// <summary>
        /// Prevents a default instance of the <see cref="iOSFormatter"/> class from being created.
        /// </summary>
        /// <param name="language">The language.</param>
        internal iOSFormatter(QueryLanguage language)
            : base(language)
        {
        }
        ...
        {
            return Format(expression, new iOSLanguage());
        }
        ...
        {
            iOSFormatter formatter = new iOSFormatter(language);
