...
namespace DataAccess.Xamarin.Android.Linq
{
    ...
    /// 
    /// </summary>
    public class AndroidFormatter : SqlFormatter
    {
        /// <summary>
        /// Prevents a default instance of the <see cref="AndroidFormatter"/> class from being created.
        /// </summary>
        /// <param name="language">The language.</param>
        internal AndroidFormatter(QueryLanguage language)
            : base(language)
        {
        }
        ...
        {
            return Format(expression, new AndroidLanguage());
        }
        ...
        {
            AndroidFormatter formatter = new AndroidFormatter(language);
