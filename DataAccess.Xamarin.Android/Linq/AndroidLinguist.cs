...
namespace DataAccess.Xamarin.Android.Linq
{
    ...
    /// 
    /// </summary>
    public class AndroidLinguist : QueryLinguist
    {
        /// <summary>
        ...
        public AndroidLinguist(AndroidLanguage language, QueryTranslator translator)
        ...
        {
            return AndroidFormatter.Format(expression);
        }
    }
}
